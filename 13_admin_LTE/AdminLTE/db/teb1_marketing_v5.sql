...
--
-- Host: 127.0.0.1
-- Czas generowania: 21 Lut 2021, 14:14
...
INSERT INTO `customers` (`id`, `cities_id`, `nationality_id`, `name`, `surname`, `gender`, `email`, `pass`, `birthday`, `create_date`) VALUES
(1, 6, 176, 'Imie', 'Nazwisko', 'm', 'pet@ret.pl', '$argon2id$v=19$m=65536,t=4,p=1$c3hiM2wuY09KSGhwWmhuNQ$wYmcIaVxmZwrXUKtAWX49owSHyOs2ra/EAChZ3xzwuI', '2021-02-09', '2021-02-20 14:39:10'),
(2, 819, 176, 'aleksa', 'nowak', 'm', 'aaa@aaa.pl', '$argon2id$v=19$m=65536,t=4,p=1$MzJhRXZGQW44WWViMlZpeg$fKGqtclGSWS2SP8RbLDIkf0/RuAwvf+FiN9ShY5h/y4', '2020-10-08', '2021-02-20 15:39:28'),
(3, 1, 4, 'tadek', 'tadek', 'm', 'mail@mail.com', '$argon2id$v=19$m=65536,t=4,p=1$LkZTbFJ5LmxlUTdNT3JJTg$6QmebM6hUI/FgodW1Rh/jhfFvasdvZRA/uHVM9ZVPXw', '2021-01-07', '2021-02-21 10:53:37'),
(4, 853, 176, 'lak', 'jak', 'f', 'tak@tak.pl', '$argon2id$v=19$m=65536,t=4,p=1$MDFwUFdFdUdHUDV4VzNDbA$VlBsaYwJJKBGFOkpQJuR/I8aalhTH+KaPFuXb8TOxSI', '2020-11-13', '2021-02-21 11:08:49'),
(5, 853, 176, 'taka', 'niska', 'f', 'taka@niska.pl', '$argon2id$v=19$m=65536,t=4,p=1$TkpTMzhmbXBiMXBvcHV0Yg$zeMSVMR2x/kOzu+m6Douj1pFd4Oponv55djtLtYRjs8', '2020-12-03', '2021-02-21 11:32:11'),
(6, 853, 176, 'taki', 'niski', 'm', 'taki@niski.pl', '$argon2id$v=19$m=65536,t=4,p=1$RHF2c0dwNWdoZ3lhVTQ1Sw$zzhOumrONWG8o+A6BQsewrJ1dnXCTDswgLxVZZsPuqE', '2020-12-03', '2021-02-21 11:32:49'),
(7, 853, 176, 'test1', 'test1', 'f', 'test@test1.pl', '$argon2id$v=19$m=65536,t=4,p=1$cFVRbk9oNURTSzFoL1R0eg$TW6KCFyHPbA1PzST8dhNj3NALmF0IPw4fHi75bDMUa8', '2020-12-11', '2021-02-21 13:42:22'),
(8, 853, 176, 'test2', 'test2', 'f', 'test@test2.pl', '$argon2id$v=19$m=65536,t=4,p=1$SEp1UUlHSnRJRFM3RWF5cg$OAXmPnBxd8ridkuU/H6y0xghg5ONlko2i2H1nLGqkPU', '2020-12-11', '2021-02-21 13:43:13');
