/*!
calendar v5.3.2
Docs & License: https://calendar.io/
(c) 2020 Adam Shaw
*/
var calendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    if (globalObj.calendarVDom) {
        console.warn('calendar VDOM already loaded');
    }
    else {
        globalObj.calendarVDom = {
            Component: d,
            createElement: h,
            render: O,
            createRef: y,
    ...
    /* calendar-specific DOM Utilities
    ----------------------------------------------------------------------------------------------------------------------*/
    ...
    */
    ...
    /// <reference types="@calendar/core-preact" />
    if (typeof calendarVDom === 'undefined') {
        throw new Error('Please import the top-level calendar lib before attempting to import a plugin.');
    }
    var Component = calendarVDom.Component;
    var createElement = calendarVDom.createElement;
    var render = calendarVDom.render;
    var createRef = calendarVDom.createRef;
    var Fragment = calendarVDom.Fragment;
    var createContext$1 = calendarVDom.createContext;
    var flushToDom$1 = calendarVDom.flushToDom;
    var unmountComponentAtNode$1 = calendarVDom.unmountComponentAtNode;
    ...
    */
    ...
    // https://github.com/calendar/calendar/issues/3615
    ...
    */
    ...
    Leverages calendar's internal drag-n-drop functionality WITHOUT a third-party drag system.
    */
    ...
    */
    ...
    /*
    Bridges third-party drag-n-drop systems with calendar.
    ...
    */
    ...
    var eventSourceDef$3 = {
        ...
        fetch: function (arg, onSuccess, onFailure) {
            ...
            if (!apiKey) {
                onFailure({
                    message: 'Specify a googleCalendarApiKey. See http://calendar.io/docs/google_calendar/',
                });
            }
            else {
