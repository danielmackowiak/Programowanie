...
--
-- Host: 127.0.0.1
-- Czas generowania: 21 Lut 2021, 10:25
...
INSERT INTO `customers` (`id`, `cities_id`, `nationality_id`, `name`, `surname`, `email`, `pass`, `birthday`, `create_date`) VALUES
(1, 6, 176, 'Imie', 'Nazwisko', 'pet@ret.pl', '$argon2id$v=19$m=65536,t=4,p=1$c3hiM2wuY09KSGhwWmhuNQ$wYmcIaVxmZwrXUKtAWX49owSHyOs2ra/EAChZ3xzwuI', '2021-02-09', '2021-02-20 14:39:10'),
(2, 819, 176, 'aleksa', 'nowak', 'aaa@aaa.pl', '$argon2id$v=19$m=65536,t=4,p=1$MzJhRXZGQW44WWViMlZpeg$fKGqtclGSWS2SP8RbLDIkf0/RuAwvf+FiN9ShY5h/y4', '2020-10-08', '2021-02-20 15:39:28');
