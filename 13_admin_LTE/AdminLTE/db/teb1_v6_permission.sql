...
--
-- Host: 127.0.0.1
-- Czas generowania: 06 Mar 2021, 14:52
...
INSERT INTO `countries` (`id`, `country`, `twoCharCountryCode`, `threeCharCountryCode`) VALUES
...
INSERT INTO `customers` (`id`, `cities_id`, `nationality_id`, `permission_id`, `name`, `surname`, `gender`, `email`, `pass`, `birthday`, `create_date`) VALUES
(1, 6, 176, 1, 'Imie', 'Nazwisko', 'm', 'pet@ret.pl', '$argon2id$v=19$m=65536,t=4,p=1$c3hiM2wuY09KSGhwWmhuNQ$wYmcIaVxmZwrXUKtAWX49owSHyOs2ra/EAChZ3xzwuI', '2021-02-09', '2021-02-20 14:39:10'),
(2, 819, 176, 1, 'aleksa', 'nowak', 'm', 'aaa@aaa.pl', '$argon2id$v=19$m=65536,t=4,p=1$MzJhRXZGQW44WWViMlZpeg$fKGqtclGSWS2SP8RbLDIkf0/RuAwvf+FiN9ShY5h/y4', '2020-10-08', '2021-02-20 15:39:28'),
(3, 1, 4, 1, 'tadek', 'tadek', 'm', 'mail@mail.com', '$argon2id$v=19$m=65536,t=4,p=1$LkZTbFJ5LmxlUTdNT3JJTg$6QmebM6hUI/FgodW1Rh/jhfFvasdvZRA/uHVM9ZVPXw', '2021-01-07', '2021-02-21 10:53:37'),
(4, 853, 176, 1, 'lak', 'jak', 'f', 'tak@tak.pl', '$argon2id$v=19$m=65536,t=4,p=1$MDFwUFdFdUdHUDV4VzNDbA$VlBsaYwJJKBGFOkpQJuR/I8aalhTH+KaPFuXb8TOxSI', '2020-11-13', '2021-02-21 11:08:49'),
(5, 853, 176, 1, 'taka', 'niska', 'f', 'taka@niska.pl', '$argon2id$v=19$m=65536,t=4,p=1$TkpTMzhmbXBiMXBvcHV0Yg$zeMSVMR2x/kOzu+m6Douj1pFd4Oponv55djtLtYRjs8', '2020-12-03', '2021-02-21 11:32:11'),
(6, 853, 176, 1, 'taki', 'niski', 'm', 'taki@niski.pl', '$argon2id$v=19$m=65536,t=4,p=1$RHF2c0dwNWdoZ3lhVTQ1Sw$zzhOumrONWG8o+A6BQsewrJ1dnXCTDswgLxVZZsPuqE', '2020-12-03', '2021-02-21 11:32:49'),
(7, 853, 176, 1, 'test1', 'test1', 'f', 'test@test1.pl', '$argon2id$v=19$m=65536,t=4,p=1$cFVRbk9oNURTSzFoL1R0eg$TW6KCFyHPbA1PzST8dhNj3NALmF0IPw4fHi75bDMUa8', '2020-12-11', '2021-02-21 13:42:22'),
(8, 853, 176, 1, 'test2', 'test2', 'f', 'test@test2.pl', '$argon2id$v=19$m=65536,t=4,p=1$SEp1UUlHSnRJRFM3RWF5cg$OAXmPnBxd8ridkuU/H6y0xghg5ONlko2i2H1nLGqkPU', '2020-12-11', '2021-02-21 13:43:13'),
(9, 859, 176, 1, 'paula', 'Niemczyk', 'f', 'paulaniemczyk@gmail.com', '$argon2id$v=19$m=65536,t=4,p=1$TXUySlN4ZjZCbW1vTHN4SQ$jLepbrSTFtx1qiL33WNuIKqtZBmyYEDZJq7IjP1hyD4', '1997-05-01', '2021-02-21 18:50:48'),
(10, 853, 176, 1, 'polak', 'niemiec', 'f', 'polak@niemiec.com', '$argon2id$v=19$m=65536,t=4,p=1$UlVQbXF6c1hjOWdFUjNvcw$vAP3JWuqCjhgheOT3S+048eISChAMInb1OiSpX4S7ls', '2021-02-03', '2021-03-06 09:49:01'),
(12, 853, 176, 1, 'polak1', 'niemiec1', 'f', 'polak@niemiec1.com', '$argon2id$v=19$m=65536,t=4,p=1$UW1jRUE4VFRSdEhiZVhTQQ$vfCBTlz+yE4SBLUeZiFVNAD2xnFHDyQW0XChr4jfWvk', '2021-02-03', '2021-03-06 09:51:25'),
(14, 853, 176, 1, 'polak12', 'niemiec12', 'f', 'polak@niemiec21.com', '$argon2id$v=19$m=65536,t=4,p=1$QjNxZjRDZkhadktRdTA1Sw$7MKbbqu9htrzwajNwpUXjfQf2qwrHsg75LTujsfkWkw', '2021-02-03', '2021-03-06 10:16:42'),
(16, 853, 176, 1, 'polak123', 'niemiec123', 'f', 'polak@niemiec231.com', '$argon2id$v=19$m=65536,t=4,p=1$TFV6VzRwY0d2ZnBLZkRtdA$eV8ByfCggzv0L7e7YwMR+cj0RAWzfLGcaSNURl8Amy8', '2021-02-03', '2021-03-06 10:20:40'),
(18, 853, 176, 1, 'qwe', 'qwe', 'm', 'qwe@qwe.pl', '$argon2id$v=19$m=65536,t=4,p=1$Wlp0Tkoud0xyTjl3TGdWWQ$4bW5r/6028v+5c9YS+jXSBDQqHRos8w2lnZCK+QWhRo', '2020-12-19', '2021-03-06 10:21:46'),
(20, 853, 176, 1, 'qwe1', 'qwe1', 'm', 'qwe@qwe1.pl', '$argon2id$v=19$m=65536,t=4,p=1$MkppSGk5M0VJcHouaGdQeg$EYDQVnWgiXsXvaA4d2feoeRWgUqcAuOiEtP8ZuBFvtc', '2020-12-19', '2021-03-06 10:25:38'),
(22, 853, 176, 1, 'qwe12', 'qwe12', 'm', 'qwe@qwe12.pl', '$argon2id$v=19$m=65536,t=4,p=1$NG1wL0wxTDdEcVoxRGd0bA$SeyM2VigI++OA6omuTR0iIpM+BWs9c7xozwub/V79xs', '2020-12-19', '2021-03-06 10:27:41'),
(24, 853, 176, 1, 'qwe123', 'qwe123', 'm', 'qwe@qwe123.pl', '$argon2id$v=19$m=65536,t=4,p=1$MDFqU2hyMFBrUlVuQ3d6TA$zomLrbqxf9TaBxUwKQJoz5dgvILTkIxdKtRuVYcKo9Q', '2020-12-19', '2021-03-06 10:28:49'),
(26, 853, 176, 1, 'qwe1234', 'qwe1234', 'm', 'qwe@qwe1243.pl', '$argon2id$v=19$m=65536,t=4,p=1$N2VILy41YmllYXBJMjZtRg$7jQzQqZvmoA4bhwrgi52U7ce1Zwk99JIdfNoGGtEvVw', '2020-12-19', '2021-03-06 10:29:44'),
(27, 853, 176, 1, 'adam', 'adam', 'f', 'adam@adam.pl', '$argon2id$v=19$m=65536,t=4,p=1$NGcuUEJYQXNnWFo1N1Q5cw$XjRzIa/Tp75b1BPu0Ls9c2eKnB65bcHcZmtQ5wcSESw', '2021-03-05', '2021-03-06 12:17:43');

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `customer_marketing`
--
...
--
-- Zrzut danych tabeli `customer_marketing`
--

INSERT INTO `customer_marketing` (`id`, `customers_id`, `marketing_id`, `start_date`, `end_date`) VALUES
(1, 24, 1, '2021-03-06 10:28:49', NULL),
(2, 24, 2, '2021-03-06 10:28:49', NULL),
(3, 26, 1, '2021-03-06 10:29:44', NULL),
(4, 26, 2, '2021-03-06 10:29:44', NULL),
(5, 27, 1, '2021-03-06 12:17:43', NULL),
(6, 27, 2, '2021-03-06 12:17:43', NULL);

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `marketing`
--
...
--
-- Zrzut danych tabeli `marketing`
--

INSERT INTO `marketing` (`id`, `marketing_name`, `description`, `active`) VALUES
(1, 'Przetwarzanie danych osobowych', 'Wyrażam zgodę na otrzymywanie od Czerwony Kapturek drogą elektroniczną na wskazany przeze mnie w Formularzu adres e-mail informacji handlowych, dotyczących produktów i uslug oferowanych przez Czerwony Kapturek w rozumieniu ustawy o świadczeniu usług drogą elektroniczną z dnia 18 lipca 2002 r. (Dz. U z 2013 r., poz. 1422 ze zm.)', 1),
(2, 'Email - marketing', 'Zgoda Zgoda zoda zgoda', 1);
...
(22, 'POMORSKIE', 176),
(24, 'ŚLĄSKIE', 176),
(26, 'ŚWIĘTOKRZYSKIE', 176),
(28, 'WARMIŃSKO-MAZURSKIE', 176),
(30, 'WIELKOPOLSKIE', 176),
(32, 'ZACHODNIOPOMORSKIE', 176);
...
--
-- Indeksy dla tabeli `customer_marketing`
--
ALTER TABLE `customer_marketing`
  ADD PRIMARY KEY (`id`),
  ADD KEY `customers_id` (`customers_id`,`marketing_id`),
  ADD KEY `marketing_id` (`marketing_id`);

--
-- Indeksy dla tabeli `marketing`
--
...
ALTER TABLE `permissions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_permission` (`permission`);
...
--
-- AUTO_INCREMENT dla tabeli `customer_marketing`
--
ALTER TABLE `customer_marketing`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT dla tabeli `marketing`
--
ALTER TABLE `marketing`
...
ALTER TABLE `customers`
  ...
  ADD CONSTRAINT `customers_ibfk_2` FOREIGN KEY (`nationality_id`) REFERENCES `countries` (`id`),
  ADD CONSTRAINT `customers_ibfk_3` FOREIGN KEY (`permission_id`) REFERENCES `permissions` (`id`);

--
-- Ograniczenia dla tabeli `customer_marketing`
--
ALTER TABLE `customer_marketing`
  ADD CONSTRAINT `customer_marketing_ibfk_1` FOREIGN KEY (`marketing_id`) REFERENCES `marketing` (`id`),
  ADD CONSTRAINT `customer_marketing_ibfk_2` FOREIGN KEY (`customers_id`) REFERENCES `customers` (`id`);

--
-- Ograniczenia dla tabeli `states`
--
ALTER TABLE `states`
  ADD CONSTRAINT `states_ibfk_1` FOREIGN KEY (`countries_id`) REFERENCES `countries` (`id`);
COMMIT;
